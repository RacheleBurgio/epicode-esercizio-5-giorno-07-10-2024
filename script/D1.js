...
let undefined /* in questo caso è presente la variabile ma non vi è stata un'assegnazione */
...
*/
let somma = 12 + 20
console.log('valore somma', somma)
...
myName = 'Burgio'
console.log(myName)
const surname = 'Burgio'
surname =
  'Di Caprio' /* in questo caso la console darà errore perché non è possibile cambiare la costante */
